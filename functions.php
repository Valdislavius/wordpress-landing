<?php
    ...
    function add_scripts_and_styles() {
        ...
        wp_enqueue_script( 'main.js', get_template_directory_uri(). '/assets/js/main.js', array('jquery', 'swiper-script'), null, 'footer');
...
<!-- add_action( 'wp_equeue_scripts', 'add_scripts_and_styles' );
add_theme_support( 'custom-logo' );
...
function add_scripts_and_styles() {
    ...
    wp_eqnueue_style('fontello', get_template_directory_uri() . '/assets/css/fontello.css');
    wp_enqueue_style('swiper-style', get_template_directory_uri() . '/assets/css/swiper-bundle.min.css');
    wp_enqueue_style('main', get_template_directory_uri(), array('fontello', 'swiper-style'));
} -->
